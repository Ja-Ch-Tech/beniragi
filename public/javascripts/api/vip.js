            ...
            if (data.getEtat) {
                var contentHead = `<div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <h2 class="poppins-font-uppercase" style="margin-bottom: 15px; display: inline-block;">Premium<img src="/images/badge_premium.png" style="width: 35px; height: 30px;"/></h2>
